...
3. Place **PlayerAPI** `playerapi-2.1.0.jar` (or newer) in your mods folder.
4. Place **Ceres** `ceres-1.1.7.jar` in your mods folder.
...
`BotConfig` persists to `config/ceres/config.json`. Schema version 3. All migrations run automatically — old config files are upgraded transparently.
